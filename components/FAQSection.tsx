      ...
      <div className="max-w-7xl mx-auto">
        <div className="grid grid-cols-1 lg:grid-cols-[1fr_360px] gap-16">
          ...
          <div className="lg:pt-16">
            <div className="process-step-highlighted rounded-2xl p-8 sticky top-28">
              <h3 className="heading-h3 mb-3">Let&apos;s Build Something Great Together</h3>
              <p className="para text-sm mb-8">
                A discovery call is your first step towards a high-performing website.
              </p>
              <div className="border-t border-white/10 pt-6">
                <p className="heading-h4 mb-4">📅 Connect Tomorrow at 11 AM?</p>
                <a
                  href="https://calendly.com/talkwithfaiz/30min"
                  target="_blank"
                  rel="noopener noreferrer"
                  className="base-button-yellow inline-flex"
                >
                  Schedule a Call
                </a>
              </div>
